...
class WildGeneratorModel5 : public TableModel<WildState>
{
    Q_OBJECT
public:
    explicit WildGeneratorModel5(QObject *parent, Method method);
...
private:
    Method method;
    QStringList header = { tr("Advances"), tr("Chatot"), tr("Slot"), tr("PID"), tr("Shiny"), tr("Nature"), tr("Ability"), tr("HP"),
                           tr("Atk"),      tr("Def"),    tr("SpA"),  tr("SpD"), tr("Spe"),   tr("Hidden"), tr("Power"),   tr("Gender") };

    int getColumn(int column) const;
};

class WildSearcherModel5 : public TableModel<SearcherState5<WildState>>
{
    Q_OBJECT
public:
    explicit WildSearcherModel5(QObject *parent, Method method);
    void setMethod(Method method);
