...
WildGeneratorModel5::WildGeneratorModel5(QObject *parent, Method method) : TableModel<WildState>(parent), method(method)
{
}

void WildGeneratorModel5::setMethod(Method method)
{
    this->method = method;
...
WildSearcherModel5::WildSearcherModel5(QObject *parent, Method method) : TableModel<SearcherState5<WildState>>(parent), method(method)
{
}

void WildSearcherModel5::setMethod(Method method)
{
    this->method = method;
    emit headerDataChanged(Qt::Horizontal, 0, columnCount());
}
...
int WildSearcherModel5::getColumn(int column) const
{
    switch (method)
    {
    case Method::Method5IVs:
